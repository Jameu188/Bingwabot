...
` +
    ...
    await notifyAdmin(
      `✅ *Payment Confirmed*\n` +
        `ChatID: \`${mdEscape(chatId)}\`\n` +
        `Phone: \`${mdEscape(formatTo07(pending?.phone || expectedPhone || cbPhone || ""))}\`\n` +
        `Package: \`Ksh ${mdEscape(String(pending?.price || cbAmount || 0))} • ${mdEscape(pending?.pkgLabel || "Unknown Package")}\`\n` +
        `Amount: *Ksh ${mdEscape(String(pending?.price || cbAmount || 0))}*\n` +
        `Total Purchases: \`${mdEscape(String(totalPurchases || 0))}\`\n` +
        `Time: \`${mdEscape(when)}\`\n` +
