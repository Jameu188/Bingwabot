...
Help: ${HELP_PHONE}`, { ...mainMenuKeyboard() });
      ...
      const found = entries.find(([, r]) => r && r.reqId === reqId2 && r.status === "pending");
      if (!found) {
...
await sendTracked(
  ...
  `✅ Payment Confirmed
` +
    `Your payment of Ksh ${amountPaid} has been received and your request is being processed.
` +
