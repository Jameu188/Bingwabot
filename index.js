...
// (moved) PERIODIC TASKS moved to core/dailyReset.js
...
Approve override?`,
      {
        reply_markup: {
          inline_keyboard: [
            ...
            [{ text: "❌ Declin
// (moved) PHONE LOCK (phone reuse + admin approval) moved to core/phoneLock.js
...
// ---------- 2️⃣ STK FAILURE INC
// (moved) ADVANCED RISK PROTECTION LAYER moved to core/riskEngine.js


// (moved) Withdrawal minimum-spend guard moved to core/withdrawalGuard.js


// ===== Initialize modular core systems (after all helpers/functions exist) =====
let __coreCtx = null;
