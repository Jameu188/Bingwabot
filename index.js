...
// ✅ PayHero callback endpoint (FIXED to match your Render logs: status:true + response:"{...User_Reference...woocommerce_payment_status...}")
app.post("/payhero/callback", async (req, res) => {
  try {
    ...
    // ✅ externalRef field mapping (PayHero often uses User_Reference)
    const externalRef =
    ...
    // ✅ status mapping (PayHero: status:true, and/or woocommerce_payment_status:"complete")
    const statusRaw =
