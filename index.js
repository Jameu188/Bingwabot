...
// Inline action buttons (Upgrade + Buy Again + Buy Offers)
    ...
    try {
      await notifyAdmin(
        `✅ *USER PAID*\n` +
        `ChatID: \`${mdEscape(chatId)}\`\n` +
        `Offer: *${mdEscape(packageName)}*\n` +
        `Payment: *${mdEscape(formatTo07(pending?.phone254 || ""))}*\n` +
        `Receive: *${mdEscape(formatTo07(pending?.receivePhone254 || pending?.phone254 || ""))}*\n` +
        `Receipt: *${mdEscape(mpesaOut)}*\n` +
