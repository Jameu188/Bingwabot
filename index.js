...
` +
      `Use: \`${mdEscape(referralCommand)}\` (share this code)
...
` +
      `⭐ Your points: *${mdEscape(u.points.toFixed(2))} pts*
` +
      `👤 Total referrals: *${mdEscape(String(totalReferrals))}*
` +
      `🤑 Total earned: *${mdEscape(totalEarned.toFixed(0))} KSH*
