...
async function sendHelpMenu(chatId) {
  return sendTracked(chatId, helpMenuText(), { parse_mode: "Markdown", ...helpMenuKeyboard() });
}

async function sendHelpAnswer(chatId, key) {
  return sendTracked(chatId, helpAnswerText(key), { parse_mode: "Markdown", ...helpAnswerKeyboard() });
}
