...
const PAYHERO_CHANNEL_ID_BUSINESS = 1975; // ✅ Business subscription channel
...
const BUSINESS_PLANS = {
  BUS_1M: { label: "Business 1 Month", price: 100, months: 1 },
  BUS_3M: { label: "Business 3 Months", price: 250, months: 3 },
};
...
function sellKeyboard() {
  return {
    reply_markup: {
      keyboard: [
        ["💼 Business 1 Month — Ksh 100"],
        ["💼 Business 3 Months — Ksh 250"],
        ["⬅ Back"],
      ],
      resize_keyboard: true,
    },
...
if (text === "💼 Business 1 Month — Ksh 100" || text === "💼 Business 3 Months — Ksh 250") {
  ...
  try {
    await payheroStkPush({
      ...
      phone: phone254,
      externalRef,
      channelId: PAYHERO_CHANNEL_ID_BUSINESS, // ✅ 1975
    });
    return;
  } catch (e) {
    deletePendingPayment(externalRef);
