  ...
  try {
    ...
    bot.on("message", async (msg) => {
      ...
      if (text === "🎉 WEEKLY DRAW") {
        ...
        // Build Top 10 participants (qualified only)
        ...
        // Winners section (shown when ENDED)
        let winnersBlock = "";
        ...
        if (img) {
          return bot.sendPhoto(chatId, img, { caption, ...mainMenuKeyboard(chatId) })
            .catch(() => bot.sendMessage(chatId, caption, mainMenuKeyboard(chatId)).catch(() => {}));
        }
