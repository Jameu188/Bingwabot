...
if (!TELEGRAM_TOKEN) { console.error("❌ TELEGRAM_TOKEN is missing. Set it in Render Env Vars."); process.exit(1); }
...
async function startPollingSafe() {
  try {
    // Clear webhook if it was set before (prevents conflicts)
...
// Auto-recover from polling errors (esp. 409 conflicts after redeploys)
