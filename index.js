...
Join Bingwa Data Bot today and compete for weekly cash prizes 🏆💸`;
  ...
  await sendTracked(chatId, msg, {
    ...
    reply_markup: {
      inline_keyboard: [
        [{ text: "📩 Get Invite Text", callback_data: "get_invite_text" }],
...
function pickReferralInviteText(chatId) {
  const referralLink = `https://t.me/${BOT_USERNAME}?start=${chatId}`;
  const normalMessages = [
    `🔥 *Save money and earn rewards!*\n\nBuy cheap offers on Bingwa Data Bot and enjoy weekly prize chances too.\n\nJoin here: ${referralLink}`,
    `🚀 *Cheap offers + rewards in one place!*\n\nI use Bingwa Data Bot for affordable deals and referral rewards.\n\nStart here: ${referralLink}`,
    `🎁 *Join Bingwa Data Bot today!*\n\nGet access to affordable offers and exciting rewards every week.\n\nTap to join: ${referralLink}`,
    `📶 *Better deals are here!*\n\nBuy offers easily on Bingwa Data Bot and enjoy extra rewards.\n\nUse my invite link: ${referralLink}`,
    `💸 *Turn every purchase into rewards!*\n\nBingwa Data Bot gives cheap offers plus a chance to win more.\n\nJoin now: ${referralLink}`,
  ];
  const premiumMessages = [
    ...
    `📶 *Better deals are here!*\n\nBuy offers easily on Bingwa Data Bot and enjoy extra rewards.\n\nUse my invite link: ${referralLink}`,
    `💸 *Turn every purchase into rewards!*\n\nBingwa Data Bot gives cheap offers plus a chance to win more.\n\nJoin now: ${referralLink}`,
    `🏆 *Weekly prizes are waiting!*\n\nUse Bingwa Data Bot for affordable purchases and reward opportunities.\n\nSign up here: ${referralLink}`,
    `⚡ *Fast, affordable and rewarding!*\n\nBingwa Data Bot makes buying offers simple and worth it.\n\nJoin with my link: ${referralLink}`,
    `🌟 *One bot, more value!*\n\nEnjoy affordable offers and referral rewards on Bingwa Data Bot.\n\nOpen here: ${referralLink}`,
    `📲 *Join the smarter way to buy offers!*\n\nBingwa Data Bot gives you great prices and extra rewards.\n\nGet started: ${referralLink}`,
    `🎉 *Affordable offers made better!*\n\nJoin Bingwa Data Bot and enjoy rewards as you buy.\n\nUse this link: ${referralLink}`,
    `💥 *Your next favorite bot is here!*\n\nBingwa Data Bot gives affordable offers plus reward benefits.\n\nJoin now: ${referralLink}`,
    `💎 *Good deals should reward you too!*\n\nThat is why I use Bingwa Data Bot.\n\nTap here: ${referralLink}`,
    `🚀 *Ready for cheap offers and bonuses?*\n\nBingwa Data Bot has both.\n\nJoin through my link: ${referralLink}`,
    `📣 *I found an easier way to buy offers!*\n\nBingwa Data Bot is affordable, quick and rewarding.\n\nSee it here: ${referralLink}`,
    `🏅 *Buy offers and unlock more value!*\n\nBingwa Data Bot keeps it simple and rewarding.\n\nJoin here: ${referralLink}`,
    `🔔 *Don’t miss affordable deals and rewards!*\n\nBingwa Data Bot is worth trying today.\n\nStart here: ${referralLink}`,
    `🌍 *Shareable, simple and rewarding!*\n\nBingwa Data Bot is a great place to buy offers cheaply.\n\nJoin now: ${referralLink}`,
    `🎯 *Affordable purchases with extra benefits!*\n\nThat is what Bingwa Data Bot gives you.\n\nUse my invite link: ${referralLink}`,
    `🥳 *Join Bingwa Data Bot and enjoy more!*\n\nCheap offers, easy process and reward opportunities.\n\nTap to open: ${referralLink}`,
    `✅ *A simple way to save on offers!*\n\nBingwa Data Bot helps you buy affordably and earn rewards too.\n\nJoin here: ${referralLink}`,
  ];
  const pool = (typeof isBusinessActive === "function" && isBusinessActive(chatId)) ? premiumMessages : normalMessages;
...
bot.on("callback_query", async (q) => {
  try {
    ...
    if (q.data === "get_invite_text") {
      const inviteText = pickReferralInviteText(chatId);
      await bot.sendMessage(chatId, inviteText, { parse_mode: "Markdown" });
      await bot.answerCallbackQuery(q.id, { text: "Invite text sent ✅", show_alert: false });
      return;
    }
