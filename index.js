...
` +
  ...
  if (text === "🔁 Buy Last Offer") {
    ...
    // Start the same flow as Buy Again (uses lastPurchase)
    sessions.set(chatId, { step: "confirmLast", category: lp.category, selectedPkg: { label: lp.pkgLabel, price: lp.price } });
    return sendTracked(
      chatId,
      `🔁 *Buy Last Offer*\n\nCategory: *${mdEscape(lp.category)}*\nOffer: *${mdEscape(lp.pkgLabel)}*\nPrice: *Ksh ${mdEscape(String(lp.price || ""))}*\n\n✅ Tap Proceed to pay or Change Number.`,
