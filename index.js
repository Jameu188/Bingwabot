...
function isBlocked(chatId) {
  // Uses db.blockedUsers map set by admin actions / anti-fraud logic
  db = repairDB(db);
...
// ===============================================================
// 🔥 ENHANCED LEDGER + NET REVENUE ANALYTICS EXTENSION (FINAL FIX)
// ===============================================================
...
// Wrap revenue tracking ONCE only
if (typeof __originalRecordSuccessfulRevenue === "undefined") {
  var __originalRecordSuccessfulRevenue = recordSuccessfulRevenue;
...
console.log("🔥 Revenue wrapper safely loaded");
