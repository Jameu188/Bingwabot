...
function weeklyDrawBroadcastText() {
  ...
  const how = tr(chatId,"✅ Tap ${tr(chatId,"🎉 WEEKLY DRAW","🎉 DROO YA WIKI")} in the bot menu to view status, join/leave, and track your rank.","✅ Bonyeza 🎉 DROO YA WIKI kwenye menyu ya bot kuona hali, kujiunga/kutoka na kufuatilia nafasi yako.");
...
function weeklyDrawLastWinnersText(chatId) {
  ...
  function buildWeeklyDrawMainCaption(chatId) {
    ...
    const listLines = ranked.length
      ...
      : tr(chatId, "${tr(chatId,'No qualified participants yet.','Bado hakuna washiriki waliohitimu.')}", "Bado hakuna washiriki walioqualify.");
...
let optedLine = tr(chatId, "${tr(chatId,'ℹ️ You are not opted in (no campaign messages). Tap ✅ JOIN to participate.','ℹ️ Hujajiunga (hutapokea taarifa za kampeni). Bonyeza ✅ JIUNGE kushiriki.')}", "ℹ️ Hujajiunga (hutapokea ujumbe wa kampeni). Bonyeza ✅ JIUNGE kushiriki.");
