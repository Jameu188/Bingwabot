...
if (data.startsWith("biz_plan:")) {
  ...
  // If user taps the currently active plan -> deactivate
...
function businessPlansInlineKeyboard(chatId) {
  ...
  // Navigation (same style as other Help pages)
  rows.push([{ text: "⬅️ Back to Help", callback_data: "help:menu" }, { text: "🏠 Main Menu", callback_data: "help:home" }]);
