...
function helpAnswerText(key) {
  ...
  const spendUnlock = Number(WITHDRAW?.MIN_SPEND_TO_WITHDRAW || 300) || 300;
  const minPoints = Number(WITHDRAW?.MIN_WITHDRAW_POINTS || 0) || 0;
  const rateStr = (typeof WITHDRAW_POINTS_TO_KSH_RATE !== "undefined")
    ? `100 points = ${Math.round(100 * Number(WITHDRAW_POINTS_TO_KSH_RATE || 0.7))} Ksh`
    : "100 points = 70 Ksh";
