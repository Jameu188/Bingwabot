  ...
  return {
    reply_markup: {
      inline_keyboard: [
        ...
        [
          { text: `${campaignNotifsMark(chatId)} Stop campaign`, callback_data: "nf:campaign" },
          { text: `${cashbackNotifsMark(chatId)} Stop cashback`, callback_data: "nf:cashback" },
        ],
        [
          { text: `${referralNotifsMark(chatId)} Stop referral`, callback_data: "nf:referral" },
          { text: `${autoDelete24hMark(chatId)} Auto delete (24hrs)`, callback_data: "ad:24h" },
        ],
        [
          { text: `${autoHideButtonsMark(chatId)} Auto hide buttons`, callback_data: "bh:toggle" },
          { text: `${hideQuickActionsMark(chatId)} Hide Quick Actions`, callback_data: "qa:toggle" },
        ],
