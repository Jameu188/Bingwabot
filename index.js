...
function helpAnswerText(key, chatId) {
  ...
  switch (key) {
    ...
    case "business":
      return (
        "🏢 *Business Account*\n\n" +
        "A Business Account is designed for users who manage services, promotions, or customers through the bot. It provides additional management and system tools that are not available to regular users.\n\n" +
        "⚙️ *What a Business Account can do*\n" +
        "• Manage offers, promotions, and campaigns\n" +
        "• Access backup and system maintenance tools\n" +
        "• Control auto-delete or cleanup settings\n" +
        "• Monitor transactions, purchases, and referrals\n" +
        "• Access admin or operational controls used to maintain the service\n\n" +
        "📊 *Why it is important*\n" +
        "Business accounts help keep the system organized, secure, and running smoothly, especially when handling many users or promotional campaigns.\n\n" +
        "⚠️ *Access*\n" +
        "These features are available only to authorized business/admin users. If you do not see these options, your account may not be enabled for business access.\n\n" +
        baseSupportEn
      );
