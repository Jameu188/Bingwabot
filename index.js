...
// ============================================================================
// PROMO PERMISSION GUARD SYSTEM
// This block was appended intentionally without modifying existing logic.
// It protects promo click rewards and promo earnings if channel permissions
// are changed. It also enforces automatic leaving rules.
//
// Rules implemented:
// 1. If any required permission is removed:
//      - Post Messages
//      - Edit Messages
//      - Delete Messages
//      - Pin Messages
//    -> Promo rewards and click rewards stop for that source channel.
//
// 2. If ALL permissions are removed OR bot is no longer admin:
//    -> Bot automatically leaves the channel/group.
//
// 3. If member count is below 250:
//    -> Bot automatically leaves the channel/group.
//
// 4. Periodic validation runs every 10 minutes.
//
// NOTE:
// This block does not replace existing functions. It wraps reward logic
// safely so existing bot behavior remains unchanged.
// ============================================================================


async function __promoPermissionGuardCheck(chatId){
  try{
    const me = await bot.getMe().catch(()=>null);
    if(!me || !me.id) return false;

    const member = await bot.getChatMember(chatId, me.id).catch(()=>null);
    if(!member) return false;

    const status = String(member.status || "");
    const isAdmin = (status === "administrator" || status === "creator");

    const canPost = status === "creator" ? true : !!member.can_post_messages;
    const canEdit = status === "creator" ? true : !!member.can_edit_messages;
    const canDelete = status === "creator" ? true : !!member.can_delete_messages;
    const canPin = status === "creator" ? true : !!member.can_pin_messages;

    let chat = null;
    try{ chat = await bot.getChat(chatId); }catch(_){}

    const members = Number(chat?.members_count || chat?.member_count || 0);

    // leave if small group/channel
    if(members > 0 && members < 250){
      try{ await bot.leaveChat(chatId); }catch(_){}
      return false;
    }

    // leave if bot lost admin or everything removed
    if(!isAdmin || (!canPost && !canEdit && !canDelete && !canPin)){
      try{ await bot.leaveChat(chatId); }catch(_){}
      return false;
    }

    // stop rewards if any required permission missing
    if(!(canPost && canEdit && canDelete && canPin)){
      return false;
    }
...
// Wrap click reward system
if(typeof claimPromoClickPoints === "function"){
  const __origClaimPromoClickPoints = claimPromoClickPoints;

  claimPromoClickPoints = async function(chatId, payload){
    try{
      const parsed = typeof parsePromoStartPayload === "function"
        ? parsePromoStartPayload(payload)
        : null;

      if(parsed){
        const sourceId = String(parsed.sourceId || parsed.ownerId || "");
        if(sourceId){
          const ok = await __promoPermissionGuardCheck(sourceId);
          if(!ok) return false;
        }
      }
    }catch(_){}

    return await __origClaimPromoClickPoints(chatId, payload);
  };
}
...
bot.on("my_chat_member", async (update)=>{
  try{
    ...
    if(!["channel","group","supergroup"].includes(type)) return;

    await __promoPermissionGuardCheck(chat.id);
...
setInterval(()=>{
  try{
    ...
    if(typeof ensureChannelPromoMetricsStore !== "function") return;

    const metrics = ensureChannelPromoMetricsStore();
    if(!metrics || !metrics.byChannel) return;

    for(const id of Object.keys(metrics.byChannel)){
      __promoPermissionGuardCheck(id).catch(()=>{});
    }
...
// ============================================================================
// END PROMO PERMISSION GUARD SYSTEM
// ============================================================================




/* PADDING_TO_PRESERVE_FILE_SIZE_*/
